...
#https://www.youtube.com/playlist?list=PLqx8fDb-FZDFznZcXb_u_NyiQ7Nai674- -> Tutorial (16/50)
...
class aplicativo(Funcs,Relatorios):
    ...
    #Botão buscar:    
        self.botao_buscar = Button(self.aba1, text="Buscar",bd=2, bg= "#4682B4", fg="White",font=("Calibri",10,"bold"),
                            activebackground="#6495ED", activeforeground="White", command=self.buscar_cliente)
    ...
    #Botão limpar:
        self.botao_limpar = Button(self.aba1, text="Limpar",bd=2, bg="#4682B4", fg="White",font=("Calibri",10,"bold"),
                            activebackground="#6495ED", activeforeground="White", command=self.limpar_tela)
    ...
    def coisas_aba1(self):
        self.botao_relatorio = Button(self.aba2, text=" ↓ Relatório ↓",bd=2, bg="#4682B4", fg="White",font=("Calibri",22,"bold"),
                        activebackground="#6495ED", activeforeground="White", command=self.gerar_rel)
